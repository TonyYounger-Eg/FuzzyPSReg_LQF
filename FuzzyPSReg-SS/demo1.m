...
gsF = 0.0036;        % grid step of the box grid filter to dowmsample P_F for the fuzzy clustering
gsM = 0.0026;        % grid step of the box grid filter to dowmsample P_M for the fuzzy clustering
gsF_fine = 0.006;    % grid step of the box grid filter to dowmsample P_F for the fine registration
gsM_fine = 0.003;    % grid step of the box grid filter to dowmsample P_M for the fine registration
