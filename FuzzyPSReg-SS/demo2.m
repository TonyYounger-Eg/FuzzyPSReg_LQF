...
gsF = 90;            % grid step of the box grid filter to dowmsample P_F for the fuzzy clustering
gsM = 90;            % grid step of the box grid filter to dowmsample P_M for the fuzzy clustering
gsF_fine = 173;      % grid step of the box grid filter to dowmsample P_F for the fine registration
gsM_fine = 194;      % grid step of the box grid filter to dowmsample P_M for the fine registration
