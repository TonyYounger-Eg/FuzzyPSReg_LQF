...
N_C = 60;            % number of fuzzy clusters of each point set in the coarse registration
gsF = 0.43;          % grid step of the box grid filter to dowmsample P_F for the fuzzy clustering
gsM = 0.43;          % grid step of the box grid filter to dowmsample P_M for the fuzzy clustering
gsF_fine = 0.62;     % grid step of the box grid filter to dowmsample P_F for the fine registration
gsM_fine = 0.62;     % grid step of the box grid filter to dowmsample P_M for the fine registration
