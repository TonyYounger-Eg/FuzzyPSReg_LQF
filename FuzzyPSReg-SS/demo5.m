...
%%%%%% Parameter setting
noisyF = 1;          % 1/0 for the condition of P_F with/without noisy outliers
noisyM = 1;          % 1/0 for the condition of P_M with/without noisy outliers
trimRatio = 0.25;    % trimming ratio for partially overlapping point sets
N_C = 80;            % number of fuzzy clusters of each point set in the coarse registration
gsF = 0.0023;        % grid step of the box grid filter to dowmsample P_F for the fuzzy clustering
gsM = 0.0023;        % grid step of the box grid filter to dowmsample P_M for the fuzzy clustering
gsF_fine = 0.0041;   % grid step of the box grid filter to dowmsample P_F for the fine registration
gsM_fine = 0.0041;   % grid step of the box grid filter to dowmsample P_M for the fine registration
