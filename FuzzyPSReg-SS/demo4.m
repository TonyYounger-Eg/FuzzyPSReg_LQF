...
gsF = 0.0026;        % grid step of the box grid filter to dowmsample P_F for the fuzzy clustering
gsM = 0.0026;        % grid step of the box grid filter to dowmsample P_M for the fuzzy clustering
gsF_fine = 0.0045;   % grid step of the box grid filter to dowmsample P_F for the fine registration
gsM_fine = 0.0045;   % grid step of the box grid filter to dowmsample P_M for the fine registration
...
sigma_t = TRange/2;  % half side-length of the minimum translation cube for stopping the inner  search
